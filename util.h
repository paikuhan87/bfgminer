...
static inline
uint16_t upk_u8(const void * const bufp, const int offset)
{
...
static inline
uint16_t upk_u32be(const void * const bufp, const int offset)
{
	const uint8_t * const buf = bufp;
...
static inline
uint16_t upk_u64be(const void * const bufp, const int offset)
{
	const uint8_t * const buf = bufp;
...
static inline
uint16_t upk_u32le(const void * const bufp, const int offset)
{
	const uint8_t * const buf = bufp;
...
static inline
uint16_t upk_u64le(const void * const bufp, const int offset)
{
	const uint8_t * const buf = bufp;
